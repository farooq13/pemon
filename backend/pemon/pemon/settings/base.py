...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,http://127.0.0.1:5173/', cast=Csv())
...
ASGI_APPLICATION = "pemon.asgi.application"
...
# Detect test runs and make Celery eager to avoid external broker during tests
